...
<table class="table table-bordered malla">
    ...
    <tr class="celda">
        ...
        <td  class="<?php echo Alumno::estado($asignaturas[$pos]->id,'estado',  User::getAlumno(Yii::app()->user->getId())); ?>">
            <a rel="tooltip" data-original-title="<?php echo GxHtml::encodeEx($asignaturas[$pos]->nombre); ?>">
                ...
                <?php echo (Alumno::estado($asignaturas[$pos]->id,'promedio',  User::getAlumno(Yii::app()->user->getId()))=="NULO")? "--" : Alumno::estado($asignaturas[$pos]->id,'promedio',  User::getAlumno(Yii::app()->user->getId())); ?><br>
