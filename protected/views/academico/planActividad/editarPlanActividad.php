...
$this->breadcrumbs = array(
	...
	GxHtml::valueEx($model) => array('academico/verPlanActividad', 'id' => GxActiveRecord::extractPkValue($model, true)),
	Yii::t('app', 'Update'),
);
...
//        array('label' => Yii::t('app', 'Create') . ' ' . $model->label(), 'url'=>array('crear'), 'icon'=>'file'),
        array('label' => Yii::t('app', 'View') . ' ' . $model->label(), 'url'=>array('verPlanActividad', 'id' => GxActiveRecord::extractPkValue($model, true)), 'icon'=>'eye-open'),
