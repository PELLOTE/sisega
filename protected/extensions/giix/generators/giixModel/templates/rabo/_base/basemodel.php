...
abstract class <?php echo $this->baseModelClass; ?> extends <?php echo $this->baseClass; ?> {
	...
	public static function label($n = 1) {
		return Yii::t('app', '<?php echo $this->class2name($modelClass); ?>|<?php echo $this->class2name($this->pluralize($modelClass)); ?>', $n);
	}
...
<?php foreach($rules as $rule): ?>
			<?php echo $rule.",\n"; ?>
<?php endforeach; ?>
<?php $reglas = array_merge($columns, $array_fechas); ?>
			array('<?php echo implode(', ', array_keys($reglas)); ?>', 'safe', 'on'=>'search'),
		);                        
	}
...
<?php if(strtoupper($column->dbType) == 'DATE'):?>
                $criteria->compare('<?php echo $name; ?>', Yii::app()->format->FormatoFechaBD($this-><?php echo $name; ?>)<?php echo ', true'; ?>);
                if(!empty($this-><?php echo $name; ?>_inicio) && !empty($this-><?php echo $name; ?>_termino))   
                        $criteria->addBetweenCondition('<?php echo $name; ?>', Yii::app()->format->FormatoFechaBD($this-><?php echo $name; ?>_inicio), Yii::app()->format->FormatoFechaBD($this-><?php echo $name; ?>_termino));
<?php else: ?>
